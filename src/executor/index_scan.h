...
public:
    ...
    static IndexLookup fromKeys(BufferPool &pool, File &indexFile, std::vector<int> keys);
    static IndexLookup fromKeyRange(BufferPool &pool, File &indexFile, int low_key, int high_key);
